...
compiled files produced by the travlang compiler. Different kind of files
...
in build-aux/travlang_version.m4. To bump all magic numbers is to
...
Since https://github.com/travlang/travlang/pull/12652/[PR #12652], simply run
...
boot/{travlangc,travlanglex}, build-aux/travlang_version.m4 and configure.
