...
(** Merge of modules which represent the same travlang module, in a list of t_module.
   There must be at most two t_module for the same travlang module, one for a .mli, another for the .ml.
