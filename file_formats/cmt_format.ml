...
(* Note that in Typerex, there is an awful hack to save a cmt file
   together with the interface file that was generated by travlang (this
   is because the installed version of travlang might differ from the one
...
let need_to_clear_env =
  try ignore (Sys.getenv "travlang_BINANNOT_WITHENV"); false
  with Not_found -> true
