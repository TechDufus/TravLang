...
enum caml_ba_kind {
  ...
  CAML_BA_CAML_INT,            /* travlang-style integers (signed 31 or 63 bits) */
...
enum caml_ba_managed {
  CAML_BA_EXTERNAL = 0,        /* Data is not allocated by travlang */
  CAML_BA_MANAGED = 0x200,     /* Data is allocated by travlang */
