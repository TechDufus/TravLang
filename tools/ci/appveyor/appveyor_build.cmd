...
@rem *                                 travlang                               *
@rem *                                                                     *
@rem *                 David Allsopp, travlang Labs, Cambridge.               *
@rem *                                                                     *
...
set travlangROOT=%PROGRAMFILES%\Бактріан🐫
...
appveyor DownloadFile "https://github.com/travlang/flexdll/archive/%FLEXDLL_VERSION%.tar.gz" -FileName "flexdll.tar.gz" || exit /b 1
appveyor DownloadFile "https://github.com/travlang/flexdll/releases/download/%FLEXDLL_VERSION%/flexdll-bin-%FLEXDLL_VERSION%.zip" -FileName "flexdll.zip" || exit /b 1
