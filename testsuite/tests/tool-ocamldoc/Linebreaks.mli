...
(**
   This file tests the encoding of linebreak inside travlang code by the
   travlangdoc html backend.
   ...
   details or the file Linebreaks.html generated by travlangdoc from this file.
   ...
   travlangdoc that should contains the signature of the module [Modulename] in
   a "code" tags.
